<?php
    ...
    if(!isset($_SESSION["belepes"]))$_SESSION["belepes"] = true;
    if(!isset($_SESSION["admin"]))$_SESSION["admin"] = false;
    if(!isset($_SESSION["nev"]))$_SESSION["nev"] = "";
    if(!isset($_SESSION["users"]))$_SESSION["users"] = [];
    if(!isset($_SESSION["simaProfil"]))$_SESSION["simaProfil"] = false;
    if(!isset($_SESSION["userek"]))$_SESSION["userek"] = "";

    if(isset($_GET))
    {

        if(isset($_GET["userName"]) && isset($_GET["jelszo"]) && $_GET["userName"] == "admin" && $_GET["jelszo"] == "admin")
        {
        ...
        if(isset($_GET["userName"]) && isset($_GET["jelszo"]) && $_GET["userName"] != "admin" && $_GET["jelszo"] != "admin")
        {
            ...
            {
                if($_SESSION["users"][$_GET["userName"]][0] == $_GET["jelszo"] && $_SESSION["users"][$_GET["userName"]][1] == "true")
                {
                    $_SESSION["nev"] = $_GET["userName"];
                    $_SESSION["belepes"] = false;
                    $_SESSION["admin"] = true;
                ...
                else if($_SESSION["users"][$_GET["userName"]][0] == $_GET["jelszo"] && $_SESSION["users"][$_GET["userName"]][1] == "false")
                {
                    $_SESSION["nev"] = $_GET["userName"];
                    $_SESSION["belepes"] = false;
