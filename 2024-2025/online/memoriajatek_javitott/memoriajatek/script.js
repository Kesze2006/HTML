...
function kepkirakas()
{
    ...
    for(let j = 0; j < 2; j++)
    {
        for(let i = 0; i < pardb; i++)
        {
            ...
            uj.onclick = function(){
                if (lathatolapok.length > 1 || lathatolapok.includes(this) || megtalaltparok.includes(this)) {
                    return;
                }
                ...
                if (lathatolapok[0].style.backgroundImage !== lathatolapok[1].style.backgroundImage) {
